...
async function setContact(newContact) {
  ...
  await fetch("http://localhost:8800/contact", options);
}
...
async function getDataFromJSON() {
  const data = await fetch("http://localhost:8800/contact");
...
async function deleteContact(id) {
  ...
  await fetch(`http://localhost:8800/contact/${id}`, options);
  render();
}

async function editContact(id) {
  const response = await fetch(`http://localhost:8800/contact/${id}`);
